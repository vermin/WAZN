...
gsigs = 'https://github.com/wazn-project/gitian.sigs.git'
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/wazn-project/wazn', help='Specify the URL of the repository. Default is %(default)s')
